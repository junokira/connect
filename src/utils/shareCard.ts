...
export async function createProfileShareCard(user: User, url: string) {
  ...
  gradient.addColorStop(0, "#0A0B08");
  gradient.addColorStop(0.45, "#111209");
  gradient.addColorStop(1, "#1a1a10");
  ...
  if (banner) {
    ...
    bannerGradient.addColorStop(0, "#4A3F2A");
    bannerGradient.addColorStop(1, "#6B5E3F");
