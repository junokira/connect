          ...
          {notifications.map((notification) => {
            ...
            return (
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-3xl border border-slate-200 p-4 text-left shadow-sm transition hover:-translate-y-0.5 hover:shadow-glass dark:border-white/10 ${notification.read ? "bg-white dark:bg-[#111113]" : "bg-amber-50/70 dark:bg-amber-400/[0.08]"}`}
              >
